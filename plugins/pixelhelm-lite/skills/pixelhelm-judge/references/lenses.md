...
A perspective-discovery research pass independently **rediscovered all seven** lenses from real canon and validated the aggregation below.
...
The gate is **exempt from the evidence-provenance discount** — a register call is never down-weighted for being "heuristic".
  And
