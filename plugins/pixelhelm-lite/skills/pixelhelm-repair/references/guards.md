# pixelhelm-repair guards — intent protection, scope discipline, edit mechanics
...
pixelhelm-repair mutates only what a **value/name/missing-piece** edit can clear. When
...
That re-derivation is NOT pixelhelm-repair's job. pixelhelm-repair would only be able to nudge
...
- Route it to pixelhelm-generate (rebuild from the chosen thesis) or a gated
  redesign.
