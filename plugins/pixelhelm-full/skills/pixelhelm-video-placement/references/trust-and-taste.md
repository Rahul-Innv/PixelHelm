...
pixelhelm-evaluate Layer-1 hard-gates the surrounding UI. Everything above that floor —
does the video earn its weight, does it fit the register, is the AI honest and calm —
is graded by `pixelhelm-judge` (the 7-seat panel) + the owner against the active project
