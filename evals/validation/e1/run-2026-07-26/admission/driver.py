# E1 admission driver: builds the original selection request for the E1 task,
# obtains the original receipt from the ACCEPTED router, builds the continuation,
# and runs the committed admit_choicegate.py verifier. Writes all artifacts.
...
OUT = REPO / "evals/validation/e1/run-2026-07-26/admission"
...
request = {
    ...
    "request_id": "pixelhelm-e1-kestrel-ridge-utility",
    "evaluation_time_utc": "2026-07-26T21:30:00Z",
    "task": {
