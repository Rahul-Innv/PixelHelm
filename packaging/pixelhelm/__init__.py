...
(``storm_engine``, imported verbatim from its upstream project) and PixelHelm's
design adapter (``design_adapter``). Together they produce grounded, cited,
claim-verified design briefs with honest abstains. Live model calls are
optional (``pip install pixelhelm[live]``); the deterministic offline stubs run
