...
<!-- FULL-ONLY-END -->
<!-- LITE-ONLY: A perspective-discovery research pass independently **rediscovered all seven** lenses from real canon and validated the aggregation below. -->
...
- **AA is judged, not measured here:** the measured pass/fail is `design-evaluate`
...
<!-- FULL-ONLY-END -->
<!-- LITE-ONLY: The gate is **exempt from the evidence-provenance discount** — a register call is never down-weighted for being "heuristic". -->
  And
...
- **Cite registry canon for grounded pattern claims:** when the ground context carries
  `referenceSources` (design-ground's fetch ritual), any lens/craft seat may cite a
