...
| Type scale | base 14px × ratio 1.125 (dense UI), `clamp()` fluid, ONE ratio system-wide | 1.2+ is editorial, not instrument-panel — actual scale comes from `design-typography` |
