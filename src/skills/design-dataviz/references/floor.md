...
- [What design-evaluate Layer-1 checks](#what-design-evaluate-layer-1-checks)
...
correct alignment. (Rule owned by `design-typography`; source: interfaces.rauno.me
...
- **Data ink / numbers:** meet the project AA contrast floor (design-color owns the
...
## What design-evaluate Layer-1 checks

Do not re-implement these — `design-evaluate` runs `static-gates.mjs`. This floor
