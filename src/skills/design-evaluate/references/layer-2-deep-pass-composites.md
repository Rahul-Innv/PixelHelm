...
> The council (`design-council`) *judges a tournament*; `design-evaluate` Layer-2 *audits one built UI*.
...
>
> - `${CLAUDE_PLUGIN_ROOT}/skills/design-council/references/deep-pass-composites.md` (C1–C8, P56, P45, P25, the frame, the aggregation contract)
> - `${CLAUDE_PLUGIN_ROOT}/skills/design-council/references/dataviz-canon.md` (Tufte / Cleveland-McGill / Ware — grounds C1/C2/C7)
>
...
4. **P56 ABSTAINS without a real-container re-render.** If the audit only has the flattering render, P56
   ...
   The reusable extreme-content harness lives in `design-render` (`references/recipes.md`, the
   ...
   (totals, after-tax/net values, %-offs, deltas — design-render's authoring rule). A
