...
catch { console.error("perf-budget: needs Playwright (run `npm i` in the design-render skill dir)."); process.exit(2); }
...
if (asJson) {
  ...
  console.log("design-render · scope-B performance / CWV budget lens (marketing surfaces only)");
