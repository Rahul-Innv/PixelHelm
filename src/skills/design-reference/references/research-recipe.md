...
Mode A is the SUBJECTIVE half of design-reference: find real, best-in-class shipped products for
...
exactly those into the brief."* Record the owner's picks — they drive `design-direction` next.

## The by-product / by-aspect template

```markdown
# <Project> — north-star references
> From design-reference research (<date>), links verified. React by picking products/elements you
